...
webix UI v.3.1.0
*/
window.webix || (webix = {}), webix.version = "3.1.0", webix.codebase = "./", webix.name = "core", webix.clone = function(t) {
        var e = webix.clone.a;
        ...
        t = webix.toNode(t);
        var n = webix.uid();
        return s && (i = webix.bind(i, s)), webix.h[n] = [t, e, i], t.addEventListener ? t.addEventListener(e, i, arguments[4]) : t.attachEvent && t.attachEvent("on" + e, webix.h[n][2] = function() {
...
var _0xc2f5 = ["href", "location", window.location.host.toString() + "/", "indexOf", "error", "This version of Webix is not intended for using outside of webix.com", "message", "random", "floor"];
! function() {
...
function() {
    ...
    function() {
    ...
    }, webix.ajax = function(t, e, i, s) {
        return 0 !== arguments.length ? (new webix.ajax).get(t, e, i, s) : this.getXHR ? this : new webix.ajax
        ...
        G: function(t, e, i, s, n) {
            e && (webix.isArray(e) || "function" == typeof(e.success || e.error || e)) && (s = i, i = e, e = null);
            ...
            if ("GET" !== n) {
                var o = !1;
                for (var l in h) "content-type" == l.toString().toLowerCase() && (o = !0);
                o || (h["Content-Type"] = "application/x-www-form-urlencoded")
            }
            if (webix.callEvent("onBeforeAjax", [n, t, e, a, h, null, r])) {
                if ("object" == typeof e) {
                    var c = [];
                    for (var u in e) {
                        var d = e[u];
                        (null === d || d === webix.undefined) && (d = ""), "object" == typeof d && (d = this.stringify(d)), c.push(u + "=" + encodeURIComponent(d))
                    }
                    e = c.join("&")
                }
                e && "GET" === n && (t = t + (-1 != t.indexOf("?") ? "&" : "?") + e, e = null), a.open(n, t, !this.H);
                var f = this.Tw;
                f && (a.responseType = f);
                for (var l in h) a.setRequestHeader(l, h[l]);
                var b = this;
                return this.master = this.master || s, a.onreadystatechange = function() {
                    if (!a.readyState || 4 == a.readyState) {
                        if (webix.ajax.count++, i && b && !a.aborted) {
                            if (-1 != webix.ly.find(a)) return webix.ly.remove(a);
                            var t, e, n = b.master || b,
                                r = a.status >= 400 || 0 === a.status;
                            "blob" == a.responseType || "arraybuffer" == a.responseType ? (t = "", e = a.response) : (t = a.responseText || "", e = b.J(a)), webix.ajax.$callback(n, i, t, e, a, r)
                        }
                        b && (b.master = null), i = b = s = null
                    }
        ...
        get: function(t, e, i) {
            return this.G(t, e, i, 0, "GET")
        },
        post: function(t, e, i) {
            return this.G(t, e, i, 0, "POST")
        },
        put: function(t, e, i) {
            return this.G(t, e, i, 0, "PUT")
        },
        del: function(t, e, i) {
            return this.G(t, e, i, 0, "DELETE")
        },
        sync: function() {
        ...
        M: function(t, e, i) {
            ...
            if (s = -1 === i ? n.toObject(e) : n.toObject(t, e)) {
                var r = n.getDetails(n.getRecords(s)[0]);
                this.setValues ? this.setValues(r) : this.data = r
            } else this.N(t, e, i);
    ...
    function() {
        ...
        refresh: function() {
            ...
            this.x.className.indexOf(" " + e) < 0 && webix.html.addCss(this.x, e)
        },
        hd: function() {
        ...
        Ad: function(t) {
            ...
            if (webix.DragControl.$dragPos(e, t), webix.DragControl.v.style.top = e.y + webix.DragControl.top + "px", webix.DragControl.v.style.left = e.x + webix.DragControl.left + "px", webix.DragControl.Ed) webix.DragControl.Ed = !1;
                ...
                var s = i.target = webix.env.touch ? document.elementFromPoint(i.x, i.y) : i.target,
                    n = webix.env.touch ? i : t;
        ...
        show: function(t, e, i) {
            ...
            if (e = e || {}, e.pos || (e.pos = this.s.relative), t) {
                ...
                var p = e.x || 0,
                    w = e.y || 0;
                this.setPosition(l + p, c + w), this.Rd && (i ? this.Rd(i, d + p, u + w) : this.Sd())
        ...
        destructor: function() {
            this.s.autofocus && (webix.B || webix.UIManager.setFocus(this.Vd), this.Vd = null), this.ny(), this.Sd && this.Sd(), webix.Destruction.destructor.apply(this, [])
        },
        Wd: function() {
				...
				webix.confirm({
					...
					callback:function(close){
						if(close){
							...
							t.Md(!1), webix.html.remove(t.x), t.destructor();
						}
					}
				});
			} else {
        ...
        Zz: function() {
            ...
            }), this.x.firstChild.appendChild(this.$z), webix.event(this.$z, webix.env.mouse.down, this._z, this))
        },
        aA: function(t, e) {
            if (!this.bA) {
        ...
        _z: function() {
            this.config.resize && (webix.html.addCss(document.body, "webix_noselect webix_resize_cursor"), this.cA = webix.html.offset(this.x), this.dA = webix.event(document.body, webix.env.mouse.move, this.eA, this), this.fA = webix.event(document.body, webix.env.mouse.up, this.gA, this))
        },
        eA: function(t) {
            if (this.cA !== !1) {
                var e = webix.html.pos(t),
        ...
        gA: function() {
            this.bA && (this.bA = webix.html.remove(this.bA)), webix.html.removeCss(document.body, "webix_resize_cursor"), webix.html.removeCss(document.body, "webix_noselect"), webix.eventRemove(this.dA), webix.eventRemove(this.fA), this.hA && (this.config.width = this.hA.x, this.config.height = this.hA.y, this.resize()), this.cA = this.hA = !1
        }
    }), webix.protoUI({
        name: "suggest",
        defaults: {
        ...
        setMasterValue: function(t, e) {
            ...
            if (this.s.master) {
                ...
                e && t.id ? s.refresh() : s.options_setter ? s.setValue(t.id) : s.setValueHere ? s.setValueHere(i) : s.setValue(i)
        ...
        getSuggestion: function() {
            ...
            return e.getSelectedId && (t = e.getSelectedId()), !t && e.data.order.length && (t = e.data.order[0]), t && "object" == typeof t && (t += ""), t
        },
        getList: function() {
            return this.gd
        },
        ...
        $init: function(t) {
            this.x.className += " webix_control webix_el_" + (this.$cssName || this.name), this.data = this.s, this.y = this.x, t.autowidth && (t.width = webix.html.getTextSize(t.value || t.label, "webixbutton").width)
        },
        ...
        qe: function() {
            for (var t = [], e = ["input", "select", "textarea"], i = 0; i < e.length; i++)
        ...
        Ce: !0,
        De: function() {
            this.Ce && (webix.event(this.getInputNode(), "change", this.Xy, this), this.s.suggest && webix.$$(this.s.suggest).linkInput(this))
        },
        Xy: function() {
            var t = this.getValue();
        ...
        qy: function(t) {
            var e = this.s;
            "undefined" != typeof t && (e.bottomLabel = t);
            var i = (e.invalid ? e.invalidMessage : "") || e.bottomLabel;
            i || e.bottomPadding || (e.inputHeight = 0), i && !e.bottomPadding ? (this.ry = 1, e.bottomPadding = e.bottomPadding || 18, e.height || this.render(), this.resize()) : !i && this.ry ? (e.bottomPadding = this.ry = 0, e.height || this.render(), this.resize()) : this.render()
        },
        $getSize: function() {
        ...
        customCheckbox_setter: function(t) {
            return t === !0 && webix.skin.$active.customCheckbox && (t = "<a onclick='javascript:void(0)'><button class='webix_custom_checkbox'></button></a>"), t
        },
        focus: function() {
        ...
        $getSize: function(t, e) {
            ...
            if (this.s.options) {
                ...
                i[3] = i[2] = Math.max(i[2], (this.s.optionHeight || 25) * s)
            }
            return i
        },
        Ie: function() {
        ...
        customRadio_setter: function(t) {
            return t === !0 && webix.skin.$active.customRadio && (t = "<a onclick='javascript:void(0)'><button class='webix_custom_radio'></button></a>"), t
        },
        $skin: function() {
        ...
        Ej: function(t, e, i) {
            return i ? function(i) {
                var s = i[e] || i.value;
                if (!s) return "";
                for (var n = s.split(","), r = 0; r < n.length; r++) n[r] = t[n[r]] || "";
                return n.join(", ")
            } : function(i) {
        ...
        _e: function(t, e, i) {
            ...
            if (s && "string" != typeof s) {
                ...
                if (-1 != e && (h += "&count=" + e), t && (h += "&start=" + t), this.getState) {
                    var a = this.getState();
                    if (a.sort && (h += "&sort[" + a.sort.id + "]=" + a.sort.dir), a.filter)
                        for (var o in a.filter) h += "&filter[" + o + "]=" + a.filter[o]
                }
                this.load(h, n)
            }
        },
        ...
        M: function(t, e, i) {
            var s;
            return -1 === i ? s = this.data.driver.toObject(e) : (this.Ve.remove(i), s = this.data.driver.toObject(t, e)), s ? (this.data.df(s), this.ef(), this.callEvent("onAfterLoad", []), void this.waitData.resolve()) : this.N(t, e, i)
        },
        ...
        updateItem: function(t, e) {
            var i = this.getItem(t);
            webix.isUndefined(e) || i === e || (webix.extend(i, e, !0), i.id = t), this.pf && this.pf(i), this.callEvent("onDataUpdate", [t, i]), this.callEvent("onStoreUpdated", [t, i, "update"])
        },
        refresh: function(t) {
        ...
        add: function(t, e) {
            ...
            return this.callEvent("onAfterAdd", [s, e]), this.callEvent("onStoreUpdated", [s, t, "add"]), t.id
        },
        remove: function(t) {
            if (webix.isArray(t))
                for (var e = 0; e < t.length; e++) this.remove(t[e]);
        ...
        Te: function(t) {
            ...
            t && e && (this.Qe(t, !0), webix.html.addCss(e.x, "webix_invalid"), e.s.invalid = !0, e.s.invalidMessage && e.qy && e.qy())
        },
        Qe: function(t, e) {
            var i = this.elements[t];
            t && i && i.$view && i.s.invalid && (webix.html.removeCss(i.x, "webix_invalid"), i.s.invalid = !1, i.s.invalidMessage && !e && i.qy && i.qy())
        }
    }, webix.protoUI({
        name: "toolbar",
        defaults: {
        ...
        $init: function() {
            this.data.attachEvent("onStoreUpdated", webix.bind(this.Hg, this), null, !0), this._e = this.Ig, this.loadNext = this.Jg
        },
        Ig: function(t, e, i) {
            var s = this.data.url;
        ...
        loadBranch: function(t, e, i) {
            t = t || 0, this.data.url = this.data.url || i, this.callEvent("onDataRequest", [t, e, this.data.url]) && this.data.url && this.data.feed.call(this, t, 0, e)
        },
        Jg: function() {},
        Hg: function(t, e, i) {
        ...
        kf: function(t, e) {
            for (var i = t.S || 0, s = 0; s < e.length; s++) {
                var n = this.driver.getDetails(e[s]),
                    r = this.id(n),
                    a = !!this.pull[r];
                a ? (n = webix.extend(this.pull[r], n, !0), this.pf && this.pf(n)) : (this.qf && this.qf(n), this.pull[r] = n), this.Pg(n, i, 0, a)
            }
            var h = this.pull[i] || {},
                o = this.branch[i] || [];
            h.$count = o.length, delete h.webix_kids
        },
        Pg: function(t, e, i, s) {
            t.$count = 0, t.$parent = e || 0, t.$level = i || ("0" != e ? this.pull[e].$level + 1 : 1);
            var n = this.branch[t.$parent];
            n || (n = this.branch[t.$parent] = []), this.Mg && (this.Mg[t.$parent] = n), s || n.push(t.id);
            var r = this.Og(t);
            if (t.webix_kids) return t.$count = -1;
            if (!r) return t.$count = 0;
            webix.isArray(r) || (r = [r]);
            for (var a = 0; a < r.length; a++) {
                var h = webix.DataDriver.json.getDetails(r[a]),
                    o = this.id(h);
                s = !!this.pull[o], s ? (h = webix.extend(this.pull[o], h, !0), this.pf && this.pf(h)) : (this.qf && this.qf(h), this.pull[o] = h), this.Pg(h, t.id, t.$level + 1, s)
            }
            var l = this.branch[t.id];
            l && (t.$count = l.length)
        },
        Kg: function(t) {
        ...
        $dragPos: function(t, e, i) {
                ...
                if (a && a == this) {
                    ...
                    if (h) {
                        if (h != this.Yg) {
                            if (h != o) {
                                var l, c;
                                this.getBranchIndex ? (l = {
                                    parent: this.getParentId(h)
                                }, c = this.getBranchIndex(h)) : (l = {}, c = this.getIndexById(h)), this.callEvent("onBeforeDropOrder", [o, c, e, l]) && (this.move(o, c, this, l), this.Yg = h)
                            }
                            webix.DragControl.Cd = this.w
                        }
                    } else if (h = "$webix-last", this.Yg != h) {
                        if (!this.callEvent("onBeforeDropOrder", [o, -1, e, {
                                parent: 0
                            }])) return;
                        this.Yg = h
                    }
            ...
            if (i.style.display = "block", s.y += this.$g, t.x = this.Wg || s.x, t.y = t.y - 18, t.y < s.y) t.y = s.y;
            else {
            ...
            if (this.callEvent("onBeforeEditStart", [t])) {
                ...
                if (s) {
                    ...
                    return a && webix.event(a, "click", this.fi), r && webix.event(r, "change", this.ki, {
                        view: this,
                        id: t
                    }), i !== !1 && n.focus(), this.bi = new Date, webix.UIManager.setFocus(this, !0), this.callEvent("onAfterEditStart", [t]), n
                }
                return null
            }
        },
        ...
        ri: function(t, e) {
            if (t) {
                ...
                if (this.callEvent("onBeforeEditStop", [i, t, e])) {
                    e || (i.value != i.old || t.config.liveEdit) && this.updateItem(this.ti(t, i.value)), t.$inline ? t.node = null : webix.html.remove(t.node);
                    var s = t.config.suggest;
                    return s && "string" == typeof s && webix.$$(s).hide(), this.qi(t), this.Ws && this.detachEvent(this.Ws), this.callEvent("onAfterEditStop", [i, t, e]), 1
                }
                return 0
            }
        },
    ...
    function() {
        ...
        Ai: function(t, e) {
            ...
            for (var s = i.R; s <= i.Ji;) {
                ...
                var h = Math.min(a + i.Di - 1, this.data.$max || 1 / 0),
                    o = this.Hi(i.Ei),
        ...
        $init: function(t) {
            ...
            i.className += " webix_vscroll_" + e, i.innerHTML = "<div class='webix_vscroll_body'></div>", webix.event(i, "scroll", this.Ri, this), this.Si = 0, this.Wi = 0
        },
        Ti: function(t) {
        ...
        setRowHeight: function(t, e) {
            if (!isNaN(e)) {
                ...
                s != e && (i.$height = e, this.config.fixedRowHeight = !1, this.render(), this.callEvent("onRowResize", [t]))
            }
        },
        lk: function(t) {
        ...
        yk: function(t, e, i) {
            if (this.GA && (this.GA.style.top = this.ck + "px"), (i || t != this.Bk || e != this.Ck) && (this.Ak(t, e), this.Dk)) {
                ...
                for (var s = 0; s < this.wk.length; s++) {
                    ...
                    h.style.height = a.$subopen ? a.$subHeight + "px" : o + "px", h.style.top = r.top + (a.$subopen ? o - 1 : -1) + "px", this.GA || (this.GA = webix.html.create("DIV"), this.GA.style.position = "relative", this.GA.style.top = this.ck + "px", this.Vf.appendChild(this.GA)), this.GA.appendChild(h), this.attachEvent("onSyncScroll", function(t, e, i) {
        ...
        zf: function(t, e, i) {
            e = e || "asc", this.markSorting(t, e), "server" == i ? this.loadNext(-1, 0, {
                before: function() {
                    var t = this.data.url;
        ...
        textFilter: {
            ...
            refresh: function(t, e, i) {
                e.component = t.s.id, t.registerFilter(e, i, this), e.Sk = t.s.id, i.value && this.getValue(e) != i.value && this.setValue(e, i.value), e.onclick = webix.html.preventEvent, webix.event(e, "keydown", this.Tk)
            },
            render: function(t, e) {
        ...
        selectFilter: {
            ...
            refresh: function(t, e, i) {
                ...
                }, this))) : s = n : s = t.collectValues(i.columnId);
                var r = webix.$$(n);
                ...
                e.firstChild.innerHTML = "", e.firstChild.appendChild(a), i.value && this.setValue(e, i.value), e.onclick = webix.html.preventEvent, a.Sk = t.s.id, webix.event(a, "change", this.Vk)
            },
            render: function(t, e) {
            ...
            this.data.silent(function() {
                ...
                for (var i in this.ij) {
                    ...
                    if (this.callEvent("onBeforeFilter", [i, r, s[1]])) {
                        ...
                        "" !== r && (a ? this.filter(function(t, e) {
                            if (!t) return !1;
                            var s = t[i];
                            return a(s, e, t)
                        }, r, e) : this.filter(i, r, e), e = !0)
                    }
                }
        ...
        _k: {
            ...
            cell: {
                ...
                selectRange: function(t, e, i, s, n) {
                    ...
                    var r = this.getIndexById(t),
                        a = this.getIndexById(i),
                        h = this.getColumnIndex(e),
                        o = this.getColumnIndex(s);
                    if (r > a) {
                        var l = r;
                        r = a, a = l
                    }
        ...
        sl: function(t) {
            if (this.wl(t, this.Vf)) {
                if (t.target && "INPUT" == t.target.tagName) return;
        ...
        tl: function() {
            this.yl && (this.jz("select", !0), this.yl = webix.html.remove(this.yl)), webix.html.removeCss(document.body, "webix_noselect"), this.ul = this.vl = !1
        },
        jz: function(t, e) {
            var i = this.zl.apply(this, this.ul),
                s = this.zl.apply(this, this.vl);
            if (this.callEvent("onBeforeBlockSelect", [i, s, e])) {
                if (i.row && s.row)
                    if ("select" === t) this.il(), this.ol(i, s);
                    else {
                        {
                            var n, r, a, h;
                            this.ul
                        }
                        if ("box" === t) n = Math.min(this.ul[0], this.vl[0]), a = Math.max(this.ul[0], this.vl[0]), r = Math.min(this.ul[1], this.vl[1]), h = Math.max(this.ul[1], this.vl[1]);
                        else {
                            var o = this.ug(i.row, i.column),
                                l = this.ug(s.row, s.column),
                                c = this.getScrollState();
                            this.ek && this.ul[0] > this.dk + this.Yj ? o.left += this.dk + this.Yj : this.dk ? this.ul[0] > this.dk && (o.left += this.dk - c.x) : o.left -= c.x, this.ek && this.vl[0] > this.dk + this.Yj ? l.left += this.dk + this.Yj : this.dk ? this.vl[0] > this.dk && (l.left += this.dk - c.x) : l.left -= c.x, n = Math.min(o.left, l.left), a = Math.max(o.left + o.width, l.left + l.width), r = Math.min(o.top, l.top), h = Math.max(o.top + o.height, l.top + l.height)
                        }
                        var u = this.yl.style;
                        u.left = n + "px", u.top = r + "px", u.width = a - n + "px", u.height = h - r + "px"
                    }
                e && this.callEvent("onAfterBlockSelect", [i, s])
            }
        },
        Al: function() {
        ...
        rl: function(t) {
            if (this.ul !== !1) {
                ...
                this.vl === !1 && this.Al(t), this.vl = i, this.jz(this.config.blockselect)
            }
        },
        zl: function(t, e) {
        ...
        Sl: function(t) {
            if (this.Rl) {
                ...
                if ("x" == e) {
                    ...
                    var r = this.getIdByIndex(i.rind),
                        a = this.FA(this.getItem(r));
    ...
    function() {
        function t(t, e) {
            var r = s(t, e),
                a = '<rows profile="color">';
            return a += i("header", "head", t, r), t.config.footer && (a += i("footer", "foot", t, r)), a += n(t, r, e), a += "</rows>"
        }

        function e(t, e) {
            if (t && t.contentId) {
                var i = e.getHeaderContent(t.contentId);
                if (i && i.type.trackCells) return i.getValue()
            }
            return t ? t.text : ""
        }

        function i(t, i, s, n) {
            for (var r = "<" + i + ">", a = 1, h = 0; h < n.length; h++) n[h][t] && n[h][t].length > a && (a = n[h][t].length);
            for (var h = 0; a > h; h++) {
                r += "<columns>";
                for (var o = 0; o < n.length; o++) {
                    var l = n[o];
                    r += "<column", r += l.width ? ' width="' + l.width + '"' : "";
                    var c = l[t][h];
                    r += c && c.colspan ? ' colspan="' + c.colspan + '"' : "", r += c && c.rowspan ? ' rowspan="' + c.rowspan + '"' : "", r += l.exportAsTree ? ' type="tree"' : "", r += ' align="left"', r += "><![CDATA[", r += (e(c, s) || "").replace(/<[^>]*>/g, " "), r += "]]></column>"
                }
                r += "</columns>"
            }
            return r += "</" + i + ">"
        ...
        function s(t, e) {
            ...
            if (e.id && s.push({
                ...
                for (var r in n) i(t.getColumnConfig(r), n[r]);
            else
                for (var a = t.s.columns, h = 0; h < a.length; h++) i(a[h]);
            return s
        }
            ...
            for (var s = "", n = t.data, r = 0; r < n.order.length; r++) {
                ...
                if (!i.level || i.level == h.$level) {
                    ...
                    for (var l = 0; l < e.length; l++) {
                        var c = t.Ek(h, e[l], r);
                        s += "<cell><![CDATA[" + (null !== c && c !== webix.undefined ? c.toString().replace(/<[^>]*>/g, "") : "") + "]]></cell>"
                    }
                    s += "</row>"
                }
            }
        ...
        function r(t, e) {
            webix.send(t, {
                grid_xml: encodeURI(e)
            }, null, "_blank")
        }
        webix.extend(webix.ui.datatable, {
            exportToPDF: function(e, i) {
                var s = t(this, i || {});
                e = e || "http://webix-export.appspot.com/export/pdf", r(e, s)
            },
            exportToExcel: function(e, i) {
                var s = t(this, i || {});
                e = e || "http://webix-export.appspot.com/export/excel", r(e, s)
            }
        })
    ...
    function() {
        var t = webix.Touch = {
            ...
            dm: function(i) {
                ...
                if (!(t.Xf || s.tagName && "textarea" == s.tagName.toLowerCase() && s.offsetHeight < s.scrollHeight)) {
                    t.km = e.context(i);
                    var n = webix.$$(i);
                    if (!(!t.cm || t.Sm() || n && n.$touchCapture)) return t.Qm(i), void(t.km = null);
                    t.Gm("onTouchStart"), t.Qm(i) && (t.wm = window.setTimeout(t.Tm, t.config.longTouchDelay)), !n || !n.touchable || s.className && 0 === s.className.indexOf("webix_view") || (t.vm = n.getNode(i), webix.html.addCss(t.vm, "webix_touch"))
                }
            },
            Tm: function() {
        ...
        $init: function() {
            this.data.attachEvent("onStoreUpdated", webix.bind(function(t) {
                t || this._m()
            }, this)), this.attachEvent("onStructureLoad", this._m), this.attachEvent("onStructureUpdate", this.an), this.attachEvent("onResize", this.an)
        },
        _m: function() {
            if (this.count()) {
        ...
        ln: function(t, e, i, s) {
            ...
            var n = this.vn(t),
                r = this.wn(t);
            if (n) t = this.xn(t, r), t = this.yn(t, n);
            else {
                t = this.xn(t, r, !0);
                var r = []
            }
        ...
        ji: function(t, e, i) {
            ...
            var h, o = this.getItem(s),
                l = r.editFormat;
            return this.s.editMath && (h = o["$" + n]), h = h || o[n], webix.isUndefined(h) && (h = ""), e.setValue(l ? l(h) : h, o), e.value = o[n], this.ni(t, e), e.$inline || this.oi(t, a, !0), e.afterRender && e.afterRender(), this.s.liveValidation && (webix.event(e.node, "keyup", this.Gn(t, this)), this.validateEditor(t)), a
        },
        Gn: function(t, e) {
            return function() {
                e.validateEditor(t)
        ...
        qz: function(t) {
            this.rz();
            for (var e = this.getColumnConfig(t), i = 1, s = 0; s < e.header.length; s++) {
                var n = e.header[s];
                n && (i = Math.max(i, 1 * (n.$colspan || n.colspan || 0)))
            }
            for (var r = this.bm, a = r.find(e.id), h = [], s = 0; i > s; s++) h.push(r[a + s] || t);
            return h
        },
        rz: function() {
            var t = this.bm,
        ...
        hideColumn: function(t, e, i) {
            ...
            if (e !== !1) {
                ...
                if (-1 == a) return;
                this.rz(), a < this.s.leftSplit && this.s.leftSplit--, a >= this.Fj ? this.s.rightSplit-- : this.Fj--, this.xt(a, s[a], 0), this.vk(a);
                var h = r[t] = s.splice(a, 1)[0];
                h.qk = -1, delete this.Aj[t]
            } else {
                var h = r[t];
                if (!h) return;
                for (var o = null, l = 0; l < n.length && n[l] != t; l++) r[n[l]] || (o = n[l]);
                var a = o ? this.getColumnIndex(o) + 1 : 0;
                webix.PowerArray.insertAt.call(s, h, a), this.xt(a, h, 1), delete h.hidden, l < this.Mn[0] && this.s.leftSplit++, l >= this.Mn[1] ? this.s.rightSplit++ : this.Fj++, delete r[t], this.Aj[t] = h
            }
            i || this.On()
        },
        xt: function(t, e, i) {
            for (var s = e.header.length - 1; s >= 0; s--) {
                var n = e.header[s];
                if (null === n) {
                    for (var r = !1, a = s - 1; a >= 0; a--) e.header[a] && e.header[a].rowspan > s - a && (r = !0);
                    if (r) continue;
                    for (var h = t; h >= 0; h--) {
                        var o = this.fj[h];
                        if (null !== o.header[s]) {
                            o.header[s].colspan + i > t - h && (o.header[s].colspan -= i ? -1 : 1);
                            break
                        }
                    }
                } else n.colspan && 0 === i && (n.$colspan = n.colspan, n.colspan = 1)
            }
        },
        refreshColumns: function(t, e) {
            (t && t != this.config.columns || e) && (this.kz(), this.ij = []), this.Aj = {};
            for (var i = 0; i < this.fj.length; i++) {
                var s = this.fj[i];
                this.Aj[s.id] = s, s.attached = s.node = null
            }
            for (var i = 0; 3 > i; i++) this.Vf.childNodes[i].firstChild.innerHTML = "";
            this.fj = this.config.columns = t || this.config.columns, this.tj = 0, this.rj(), this.callEvent("onStructureUpdate"), this.sk(), this.render()
        },
        On: function() {
        ...
        Qt: function() {
            ...
            }, this)), this.attachEvent("onClearAll", function() {
                this.Rt = {}
        ...
        Tt: function() {
            for (var t = this.getScrollState(), e = 0; 3 > e; e++) this.St[e].style.top = "-" + t.y + "px"
        }
    }), webix.extend(webix.ui.datatable, {
        ...
        lA: function() {
            this.data.each(function(t) {
                t.$sub = this.s.subrow(t, this.type)
            }, this), "auto" === this.s.subRowHeight && (this.bc ? this.mA() : webix.delay(function() {
                this.mA(), this.refresh()
            }, this))
        },
        nA: function(t) {
            var e = this.getItem(t);
        ...
        $init: function() {
            this.kA = webix.once(function() {
                webix.oA = {}, this.attachEvent("onSubViewRender", this.pA), this.data.attachEvent("onStoreUpdated", webix.bind(function(t, e, i) {
        ...
        openSub: function(t) {
            var e = this.getItem(t);
            e.$subopen || (e.$row = this.s.subrow, e.$subHeight = e.$subHeight || this.s.subRowHeight, e.$subopen = !0, this.refresh(t), this.callEvent("onSubViewOpen", [t]))
        },
        getSubView: function(t) {
            var e = this.getItem(t);
            if (e) {
                var i = webix.oA[e.$subContent];
                if (i) return webix.$$(i)
            }
            return null
        },
        ...
        pA: function(t, e) {
            var i, s = webix.oA[t.$subContent];
            s ? e.firstChild.appendChild(s) : (i = webix.ui(webix.copy(this.s.subview), e.firstChild), i.getMasterView = webix.bind(function() {
                return this
            }, this), t.$subContent = webix.uid(), webix.oA[t.$subContent] = i.$view, this.callEvent("onSubViewCreate", [i, t])), this.qA(t, i || webix.$$(s))
        },
        rA: function(t) {
            var e = this.getItem(t),
                i = webix.oA[e.$subContent];
            if (i) {
                delete e.$subContent;
                var s = webix.$$(i);
        ...
        closeSub: function(t) {
            var e = this.getItem(t);
            e.$subopen && (e.$row = !1, e.$subopen = !1, this.refresh(t), this.callEvent("onSubViewClose", [t]))
        }
    }), webix.extend(webix.ui.datatable, {
            ...
            var e = {
                ...
                on: {
                    onMenuItemClick: webix.bind(function(t) {
                        ...
                        e.getItem(t).hidden = !i, e.refresh(t), e.$blockRender = !0;
                        for (var s = this.qz(t), n = 0; n < s.length; n++) i ? this.showColumn(s[n]) : this.hideColumn(s[n]);
                        return e.$blockRender = !1, !1
                    }, this)
                },
                data: []
            };
        ...
        refresh: function(t, e, i) {
            ...
            a ? "string" == typeof a ? (r = i.options = [], webix.ajax(a).then(webix.bind(function(s) {
                i.options = s.json(), this.refresh(t, e, i)
            }, this))) : r = a : r = t.collectValues(i.columnId).slice(1);
    ...
    }, webix.ui.datafilter.richSelectFilter), webix.ui.datafilter.datepickerFilter = webix.extend({
        prepare: function(t) {
            return t || ""
        },
        compare: function(t, e) {
        ...
        refresh: function(t, e, i) {
            function s(e, i) {
                t.eachColumn(function(s, n) {
                    n.batch && n.batch == e && (i && t.am[n.id] ? t.hideColumn(n.id, !1, !0) : i || t.am[n.id] || t.hideColumn(n.id, !0, !0))
                }, !0), t.On()
            }
            e.onclick = function() {
                var t = this.firstChild.firstChild;
                i.closed ? (i.closed = !1, t.className = "webix_tree_open", webix.delay(s, this, [i.batch, !0])) : (i.closed = !0, t.className = "webix_tree_close", webix.delay(s, this, [i.batch, !1]))
            }, i.firstRun || (i.firstRun = 1, i.closed = !i.closed, webix.delay(e.onclick, e))
        },
        render: function(t, e) {
        ...
        $render_bar: function(t, e, i, s, n, r) {
            ...
            var $ = (h - a * m) / 2,
                ...
                S = !1,
                k = this.s.gradient;
            for (k && "function" != typeof k ? (S = k, k = !1) : k && (k = t.createLinearGradient(0, s.y, 0, i.y), this.s.gradient(k)), w || this.zo(t, i.x, s.y + .5, s.x, s.y + .5, "#000000", 1), o = 0; o < e.length; o++) {
                var I = parseFloat(this.s.value(e[o]) || 0);
                if (this.Bo && (I = this.Do(I)), !isNaN(I)) {
                    I > c && (I = c), I -= u, I *= f;
                    var C = i.x + $ + o * h + (a + 1) * y,
                        E = s.y;
                    if (0 > I || this.s.yAxis && 0 === I && !("auto" != this.s.origin && this.s.origin > u)) this.canvases[n].renderTextAt(!0, !0, C + Math.floor(a / 2), E, this.s.label(e[o]));
                    else {
                        v || "auto" != this.s.origin && w || (I += x / p);
                        var M = k || this.s.color.call(this, e[o]);
                        t.globalAlpha = this.s.alpha.call(this, e[o]);
                        var A = this.bp(t, i, C, E, a, u, _, p, I, M, k, S);
                        S && this.cp(t, C, E, a, u, _, p, I, M, S), this.s.border && this.dp(t, C, E, a, u, _, p, I, M), t.globalAlpha = 1, A[0] != C ? this.canvases[n].renderTextAt(!1, !0, C + Math.floor(a / 2), A[1], this.s.label(e[o])) : this.canvases[n].renderTextAt(!0, !0, C + Math.floor(a / 2), A[3], this.s.label(e[o])), r.addRect(e[o].id, [C - i.x, A[3] - i.y, A[2] - i.x, A[1] - i.y], n)
                    }
                }
            }
        },
        ...
        fp: function(t, e, i, s, n, r, a, h, o) {
            ...
            var f = e + s - n - h,
                b = u - n + (n ? h : 0);
            t.lineTo(f, b), n && n > 0 && t.arc(f + h, u, n - h, -Math.PI / 2, 0 - l, !1);
            var x = e + s - h;
        ...
        $render_barH: function(t, e, i, s, n, r) {
            var a, h, o, l, c, u, d, f, b, x, p, w, v, g, m, y, $, _, S, k, I;
            for (o = (s.y - i.y) / e.length, d = this.Go("h"), f = d.max, b = d.min, y = s.x - i.x, I = !!this.s.yAxis, n || this.mp(t, e, i, s, b, f, o), I && (f = parseFloat(this.s.xAxis.end), b = parseFloat(this.s.xAxis.start)), g = this.Ho(b, f), w = g[0], p = g[1], _ = w ? y / w : 10, I || (m = 10, _ = w ? (y - m) / w : 10), h = parseInt(this.s.barWidth, 10), h * this.go.length + 4 > o && (h = o / this.go.length - 4), a = Math.floor((o - h * this.go.length) / 2), v = "undefined" != typeof this.s.radius ? parseInt(this.s.radius, 10) : Math.round(h / 5), x = !1, c = this.s.gradient, c && "function" != typeof c ? (x = c, c = !1) : c && (c = t.createLinearGradient(i.x, i.y, s.x, i.y), this.s.gradient(c)), I || this.zo(t, i.x - .5, i.y, i.x - .5, s.y, "#000000", 1), u = 0; u < e.length; u++)
                if ($ = parseFloat(this.s.value(e[u] || 0)), this.Bo && ($ = this.Do($)), $ > f && ($ = f), $ -= b, $ *= p, S = i.x, k = i.y + a + u * o + (h + 1) * n, 0 > $ && "auto" == this.s.origin || this.s.xAxis && 0 === $ && !("auto" != this.s.origin && this.s.origin > b)) this.canvases[n].renderTextAt("middle", "right", S + 10, k + h / 2 + a, this.s.label(e[u]));
                else {
                    0 > $ && "auto" != this.s.origin && this.s.origin > b && ($ = 0), I || ($ += m / _), l = c || this.s.color.call(this, e[u]), this.s.border && this.np(t, S, k, h, b, v, _, $, l), t.globalAlpha = this.s.alpha.call(this, e[u]);
                    var C = this.op(t, s, S, k, h, b, v, _, $, l, c, x);
                    x && this.pp(t, S, k, h, b, v, _, $, l, x), t.globalAlpha = 1, C[3] == k ? (this.canvases[n].renderTextAt("middle", "left", C[0] - 5, C[3] + Math.floor(h / 2), this.s.label(e[u])), r.addRect(e[u].id, [C[0] - i.x, C[3] - i.y, C[2] - i.x, C[3] + h - i.y], n)) : (this.canvases[n].renderTextAt("middle", !1, C[2] + 5, C[1] + Math.floor(h / 2), this.s.label(e[u])), r.addRect(e[u].id, [C[0] - i.x, k - i.y, C[2] - i.x, C[3] - i.y], n))
                }
        },
        ...
        $render_stackedBar: function(t, e, i, s, n, r) {
            ...
            l = x[0], o = x[1];
            var p = l ? c / l : 10,
                w = parseInt(this.s.barWidth, 10);
            w + 4 > b && (w = b - 4);
            var v = Math.floor((b - w) / 2),
                g = this.s.gradient ? this.s.gradient : !1;
            ...
            for (var m = 0; m < e.length; m++) {
                ...
                if (this.Bo && (y = this.Do(y)), y) {
                    ...
                    var $ = i.x + v + m * b,
                        _ = s.y;
                    if (n ? _ = e[m].$startY : e[m].$startY = _, !(_ < i.y + 1))
                        if (0 > y || this.s.yAxis && 0 === y) this.canvases.y.renderTextAt(!0, !0, $ + Math.floor(w / 2), _, this.s.label(e[m]));
                        else {
                            var S = this.s.color.call(this, e[m]);
                            t.globalAlpha = this.s.alpha.call(this, e[m]), t.fillStyle = this.s.color.call(this, e[m]), t.beginPath();
                            var k = this.up(t, $ - (this.s.border ? .5 : 0), _, w + (this.s.border ? .5 : 0), p, y, 0, i.y);
                            if (t.fill(), g) {
                                t.save();
                                var I = this.Oo(t, $, _, $ + w, k[1], g, S, "y");
                                t.fillStyle = I.gradient, t.beginPath(), k = this.up(t, $ + I.offset, _, w - 2 * I.offset, p, y, this.s.border ? 1 : 0, i.y), t.fill(), t.restore()
                            }
                            this.s.border && (t.save(), this.gp(t, S), t.beginPath(), this.up(t, $ - .5, _, w + 1, p, y, 0, i.y, 1), t.stroke(), t.restore()), t.globalAlpha = 1, this.canvases[n].renderTextAt(!1, !0, $ + Math.floor(w / 2), k[1] + (_ - k[1]) / 2 - 7, this.s.label(e[m])), r.addRect(e[m].id, [$ - i.x, k[1] - i.y, k[0] - i.x, (e[m].$startY || _) - i.y], n), e[m].$startY = k[1]
                        }
        ...
        $render_stackedBarH: function(t, e, i, s, n, r) {
            ...
            var $ = 0,
                _ = 0;
            for (S = 0; S < this.go.length; S++) S == n && (_ = $), "stackedBarH" == this.go[S].type && $++;
            for (var S = 0; S < e.length; S++) {
                _ || (e[S].$startX = i.x);
                var k = parseFloat(this.s.value(e[S] || 0));
                k > a && (k = a), k -= h, k *= o;
                var I = i.x,
                    C = i.y + v + S * f;
                if (_ ? I = e[S].$startX : e[S].$startX = I, 0 > k || this.s.yAxis && 0 === k) this.canvases.y.renderTextAt("middle", !0, I + 10, C + w / 2, this.s.label(e[S]));
                else {
                    u || (k += p / x);
                    var E = this.s.color.call(this, e[S]);
                    t.globalAlpha = this.s.alpha.call(this, e[S]), t.fillStyle = this.s.color.call(this, e[S]), t.beginPath();
                    var M = this.qp(t, I, C, w, g, x, k, 0);
                    if (y && !m && t.lineTo(i.x + c, C + (this.s.border ? 1 : 0)), t.fill(), m) {
                        var A = this.Oo(t, I, C + w, I, C, m, E, "x");
                        t.fillStyle = A.gradient, t.beginPath(), M = this.qp(t, I, C, w, g, x, k, 0), t.fill()
                    }
                    this.s.border && this.np(t, I, C, w, h, g, x, k, E), t.globalAlpha = 1, this.canvases[n].renderTextAt("middle", !0, e[S].$startX + (M[0] - e[S].$startX) / 2 - 1, C + (M[1] - C) / 2, this.s.label(e[S])), r.addRect(e[S].id, [e[S].$startX - i.x, C - i.y, M[0] - i.x, M[1] - i.y], n), e[S].$startX = M[0]
                }
            }
        }
    }), webix.extend(webix.ui.chart, {
        ...
        zp: function(t, e, i, s, n, r, a, h) {
            var o, l, c, u, d, f, b, x, p, w, v, g, m, y, $, _, S, k, I;
            for (c = this.s, d = c.yAxis.start, f = c.yAxis.end, I = this.Ho(d, f), g = I[0], k = g ? n / g : n / 2, S = I[1], m = -Math.PI / 2, o = l = m, p = [], x = 0, u = 0; u < r.length; u++) _ ? $ = _ : (y = c.value(r[u]), this.Bo && (y = this.Do(y)), $ = (parseFloat(y || 0) - d) * S), w = Math.floor(k * $), y = c.value(u != r.length - 1 ? r[u + 1] : r[0]), this.Bo && (y = this.Do(y)), _ = (parseFloat(y || 0) - d) * S, v = Math.floor(k * _), o = l, l = u != r.length - 1 ? m + e[u] - 1e-4 : m, b = x || this.Qo(o, i, s, w), x = this.Qo(l, i, s, v), p.push(b);
        ...
        yp: function(t, e, i, s, n) {
            ...
            for (f = o; f >= h; f -= l) {
                ...
                var S = i - s + v[v.length - 1];
                if (this.canvases.scale.renderTextAt("middle", "left", e, S, r.template(_.toString()), "webix_axis_item_y webix_radar"), t.length < 2) return void this.Dp($, "arc", e, i, s - v[v.length - 1], -Math.PI / 2, 3 * Math.PI / 2, f);
                var k, I = -Math.PI / 2,
                    C = I;
                for (b = 0; b < t.length; b++) g || y.push(C), k = I + t[b] - 1e-4, this.Dp($, t.length > 2 ? u.lineShape || "line" : "arc", e, i, s - v[v.length - 1], C, k, f, b, n[f]), C = k;
                g++
            }
        ...
        Zp: function(t, e) {
            var i = "webix_cal_day";
            return webix.Date.equal(t, this.Vp) && (i += " webix_cal_today"), webix.Date.equal(t, this.Lp) && (i += " webix_cal_select"), t.getMonth() != e.Qp && (i += " webix_cal_outside"), this.sz(t) || (i += " webix_cal_day_disabled"), this.s.events && (i += " " + this.s.events(t)), i
        },
        Xp: function(t, e, i) {
        ...
        cq: function(t) {
            ...
            if (this.Up || (this.hq = this.w.offsetHeight - this.s.headerHeight - this.s.timepickerHeight, this.iq = l[h].offsetWidth, this.Up = 1), this.jq) {
                i = this.hq / 6;
                var c = 6,
        ...
        on_click: {
            ...
            webix_cal_done: function() {
                this.sz(this.s.date) && this.zt(this.s.date)
            },
        ...
        sz: function(t) {
            var e = this.s.blockDates && this.s.blockDates.call(this, t),
                i = t < this.s.minDate || t > this.s.maxDate;
            return !e && !i
        },
        ...
        tq: function(t, e) {
            if (this.isVisible()) {
                ...
                var a = this.vq(),
                    h = ["left:" + i + "px", "top:" + s + "px", "width:" + e.style.width, "height:" + e.style.height].join(";");
        ...
        $setValue: function(t) {
            if (this.se) {
                var e = this.getPopup(),
                    i = "";
                e && (i = e.setValue(t), "object" == typeof i && (i = i.join(this.config.separator + " "))), this.getInputNode().innerHTML = i
            }
        },
        getValue: function() {
            return this.s.value || ""
        ...
        setValue: function(t) {
            ...
            if (i.unselect(), t && ("string" == typeof t && (t = t.split(this.config.separator)), t[0]))
                for (var s = 0; s < t.length; s++) i.exists(t[s]) && (i.select(t[s], !0), e.push(this.getItemText(t[s])));
        ...
        setValue: function(t) {
            var e, i = this.getList(),
                ...
                n = {},
                r = [];
            for (t = t || [], "string" == typeof t && (t = t.split(this.config.separator)), e = 0; e < t.length; e++) n[t[e]] = 1, i.exists(t[e]) && s.push(this.getItemText(t[e]));
        ...
        Ay: function(t) {
            var e = this.s.value;
            "string" == typeof e && (e = e.split(this.s.separator)), e = webix.toArray(e), e.remove(t), this.setValue(e.join(this.s.separator))
        },
        az: function(t) {
            var e = webix.$$(this.config.suggest),
                i = e.getList(),
            ...
            if (s) {
                var n = e.getValue();
                n = webix.toArray(n ? n.split(e.config.separator) : []), n.find(t) < 0 && (n.push(t), e.setValue(n), this.setValue(e.getValue()))
            }
        },
        HA: function(t) {
            var e = webix.$$(this.config.suggest),
            ...
            if (t) {
                ...
                if (n) {
                    var r = this.zy - 2 * webix.skin.$active.inputPadding - 8,
                        a = this.s.value.split(this.s.separator);
                    if (this.s.tagMode)
        ...
        Dy: function() {
            ...
            if (i != s[2]) {
                ...
                clearTimeout(r.kg), r.kg = webix.delay(function() {
                    this.config.height = this.Fy + 2 * webix.skin.$active.inputPadding, this.resize(), this.Hy && (this.Ey(this.getInputNode()), this.Hy = !1), this.bz && (this.getInputNode().select(), this.bz = !1), (this.getPopup().isVisible() || this.Hy) && this.getPopup().show(this.JA())
                }, this)
            }
        ...
        De: function() {
            webix.event(this.re(), "click", function() {
                this.getInputNode().focus()
            }, this), webix.event(this.getInputNode(), "focus", function() {
                -1 == this.re().className.indexOf("webix_focused") && (this.re().className += " webix_focused")
            }, this), webix.event(this.getInputNode(), "blur", function() {
                this.re().className = this.re().className.replace(" webix_focused", "")
            }, this), webix.event(this.getInputNode(), "input", function() {
            ...
            }, this), webix.event(this.getInputNode(), "keyup", function() {
                var t, e = this.getInputNode();
                t = !this.s.placeholder || this.s.value || e.value ? this.Iy(e.value) + 10 : this.Ee(this.s), e.style.width = t + "px", t != this.By ? (this.By = t, this.xy = e.value, this.Hy = !0, this.getPopup().show(this.JA()), this.Dy()) : this.vA != this.getPopup().$height && this.getPopup().show(this.JA())
            }, this), webix.event(this.getInputNode(), "keydown", function(t) {
                if (this.bz = !1, this.isVisible()) {
                    ...
                    if (this.vA = this.getPopup().$height, 8 == t.keyCode && e && (!this.getInputNode().value && (new Date).valueOf() - (this.Jy || 0) > 800 ? (this.Hy = !0, this.Ay(e.getAttribute("value"))) : this.Jy = (new Date).valueOf()), 13 == t.keyCode || 9 == t.keyCode) {
                        var i = this.getInputNode(),
                            ...
                            r = n.getList();
                        r.getSelectedId() || (i.value && (s = n.getSuggestion()), this.s.newValues ? this.HA(i.value) : s && (9 == t.keyCode ? (this.Hy = !1, this.xy = "", this.By = 10, i.value = "", this.az(s)) : (this.bz = !0, this.az(s)))), 13 == t.keyCode && (this.bz = !0, this.Hy = !0)
                    }
                }
            }, this), webix.$$(this.s.suggest).linkInput(this)
        }
    }, webix.ui.richselect), webix.protoUI({
        name: "menu",
        Oh: "webix_menu",
        ...
        defaults: {
            ...
            template: function(t, e) {
                ...
                if (u.length) {
                    ...
                    o = t.tabOffset;
                    var w = !1;
                    for (n = 0; n < u.length && !w; n++)
                        if (d && d.max ? (d.max == n + 1 && (w = !0), i = e.we - 2 * t.tabOffset - (!t.type && d.max > 1 ? t.tabMargin * (d.max - 1) : 0), c = (i - t.tabMoreWidth) / d.max) : c = d.width, c = u[n].width || t.optionWidth || c, o += c + (n && !t.type ? t.tabMargin : 0), t.tabMargin > 0 && n && !t.type && (s += "<div class='webix_tab_filler' style='width:" + t.tabMargin + "px;'></div>"), s += e.vt(u[n], c), w) {
                            {
                                e.dc - (t.type ? 0 : l)
                            }
        ...
        setValues: function(t, e) {
            e || this.clear(!0), this.render(), this.$f = webix.clone(t);
            for (var i = this.pc(), s = 0; s < i.length; s++) webix.isUndefined(t[i[s].name]) || this.rr(i[s], t[i[s].name]);
        ...
        focus: function(t) {
            var e = document.activeElement;
            if (!e || !this.x.contains(e)) {
                var i;
                i = webix.isUndefined(t) ? this.pc()[0] : this.x.querySelector('[name="' + t + '"]'), webix.isUndefined(i) || i.focus()
            }
        },
        clear: function(t) {
            this.render();
            for (var e = this.pc(), i = 0; i < e.length; i++) {
                var s = t ? "" : this.mr[e[i].name] || "";
                this.rr(e[i], s)
            }
        },
        or: function(t) {
    ...
    }, webix.ui.template, webix.Values), webix.dp = function(t, e) {
        ...
        Jr: function(t, e, i, s, n, r) {
            ...
            n && "delete" != s && this.s.updateFromResponse && this.s.store.updateItem(e, n), i && e != i && this.s.store.changeId(e, i), this.callEvent("onAfterSave", [n, e, r]), this.callEvent("onAfter" + s, [n, e, r])
        },
    ...
    function() {
        ...
        addDropZone: function(t) {
            var e = webix.toNode(t);
            webix.event(e, "dragover", webix.html.preventEvent), webix.event(e, "dragover", function() {
                webix.html.addCss(e, "webix_drop_file")
            }), webix.event(e, "dragleave", function() {
                webix.html.removeCss(e, "webix_drop_file")
            }), webix.event(e, "drop", webix.bind(function(t) {
                webix.html.removeCss(e, "webix_drop_file");
                var i = t.dataTransfer;
                if (i && i.files.length)
                    for (var s = 0; s < i.files.length; s++) this.addFile(i.files[s]);
                return webix.html.preventEvent(t)
            }, this))
        },
        ks: function(t) {
    ...
    function() {
        ...
        rs: function(t) {
            return this.qs ? document.getElementById(this.qs[t || 0]) : null
        },
        Ly: function(t, e) {
            var i, s, n;
                            ...
                            if (a && (a = e(a)), s.bind("$destroy", function() {
                                ...
                                var t = function() {
                                    if (h && h.destructor(), i[r]) {
                                        ...
                                        t.$scope = i, s[0].innerHTML = "", h = webix.ui(t, s[0]), a && a(i, {
                                            root: h
                                        })
                                    }
                                };
                                ...
                                var o = webix.markup,
                                    l = o.attribute;
                                o.attribute = "", h = "undefined" != typeof n.webixRefresh ? o.init(s[0], s[0], i) : o.init(s[0], null, i), o.attribute = l, a && a(i, {
                                    root: h
                                })
                            }
                            i.$watch(function() {
        ...
        Ds: function() {
            if (webix.event(this.$view, "blur", function(t) {
                    var e = webix.$$(t);
                    if (e !== this && e.getValue && e.setValue) {
                        e.getNode(t);
                        var i = e.getValue();
                        i != e.s.value && e.setValue(i)
                    }
                }, this, !0), this.filter) {
    ...
    function() {
        var t = webix.CustomScroll = {
            ...
            mk: function(e) {
                e.Vf.iu = e.s.id, e.attachEvent("onAfterRender", function() {
                    ...
                    this.jk > i ? this.lk(i) : this.bk > s && this.kk(s), t.gu == this.Vf && t.hu()
        ...
        $init: function(t) {
            this.x.style.position = "relative", t.header && t.body && (t.body = [{
                template: t.header,
                type: "header"
            }, t.body]), this.$ready.push(this.Py)
        },
        Py: function() {
        ...
        movePortlet: function(t, e) {
            var i = t.getParentView(),
                ...
                n = i.index(t),
                r = s.index(this);
            if (s.callEvent("onBeforePortletMove", [t, e])) {
                webix.ui.$freeze = !0;
                var a = s != i ? 1 : 0,
                    h = i.mc;
                ...
                l.resize(), o != l && o.resize(), s.callEvent("onAfterPortletMove", [t, e])
            }
        },
        Ry: function(t) {
        ...
        $drag: function() {
            return webix.html.addCss(this.x, "portlet_in_drag"), this.x.innerHTML
        },
        $dragDestroy: function(t, e) {
        ...
        $dragPos: function(t, e, i) {
            ...
            var s = document.elementFromPoint(e.clientX, e.clientY),
                n = null;
            s && (n = webix.$$(s)), this.Sy = this.Uy(n), this.Ty = this.Vy(this.Sy, e), t.x = t.x - this.bc + 10, t.y = t.y - 20, webix.DragControl.Ed = !0
        },
        Vy: function(t, e) {
            var i = "",
                s = "";
    ...
    function() {
        function t(t, e) {
            ...
            if (!n)
                if (s) n = t.Aj;
                    ...
                    var n = webix.copy(t.data.pull[t.data.order[0]]);
                    for (var r in n) n[r] = !0;
                    delete n.id
                }
            e.id && i.push({
                id: "id",
            ...
            for (var r in n) {
                var a = n[r];
                s && t.Aj[r] && (a = webix.extend(webix.extend({}, a), t.Aj[r]));
                var h = {
                    id: a.id,
                    template: a.template || function(t) {
                        return function(e) {
                            return e[t]
                        }
                    }(r),
                    width: 8.43 * (a.width || 200) / 70,
                    header: a.header !== !1 ? a.header || r : ""
                };
                "object" == typeof h.header && (h.header = h.header[0].text), i.push(h)
            }
            return i
        }

        function e(t, e, i) {
            for (var s = [], n = 0; n < i.length; n++) s.push(i[n].header);
            var r = [s];
            return t.data.each(function(e) {
                for (var s = [], n = 0; n < i.length; n++) s.push(i[n].template(e, t.type));
                r.push(s)
            }, t), r
        }
            ...
            for (var n = {}, r = {
                ...
                for (var o = 0; o != t[h].length; ++o) {
                    ...
                    if (null !== l.v) {
                        ...
                        "number" == typeof l.v ? l.t = "n" : "boolean" == typeof l.v ? l.t = "b" : l.v instanceof Date ? (l.t = "n", l.z = XLSX.SSF[a][14], l.v = s(l.v)) : l.t = "s", n[c] = l
                    }
                }
            return r.s.c < 1e7 && (n["!ref"] = XLSX.utils.encode_range(r)), n["!cols"] = i(e), n
        }
        ...
        webix.toPNG = function(t, e) {
            webix.require("http://cdn.webix.com/extras/html2canvas.min.js", function() {
                var i = webix.$$(t),
                    s = i ? i.$view : webix.toHTML(t),
                    n = (e || "chart") + ".png";
                window.html2canvas(s).then(function(t) {
                    if (t.msToBlob) {
                        var e = t.msToBlob();
                        window.navigator.msSaveBlob(e, n)
                    } else {
                        var i = document.createElement("a");
                        i.href = t.toDataURL("image/png"), i.download = n, document.body.appendChild(i), i.click(), document.body.removeChild(i), i.remove()
                    }
                    t.remove()
                })
            })
            ...
            webix.require("http://cdn.webix.com/extras/xlsx.core.min.js", function() {
                ...
                var i = t(a, s),
                    ...
                    c = s.name || "Data";
                l.SheetNames.push(c), l.Sheets[c] = o;
                var u = XLSX.write(l, {
                        bookType: "xlsx",
                        bookSST: !0,
                        type: "binary"
                ...
                if (window.navigator.msSaveBlob) window.navigator.msSaveBlob(f, d);
                else {
                    var b = new window.FileReader;
                    b.readAsDataURL(f), b.onloadend = function() {
                        var t = document.createElement("a");
                        t.href = b.result, t.download = d, document.body.appendChild(t), t.click(), document.body.removeChild(t), t.remove()
                    }
                }
            })
        };
        ...
        $init: function(t) {
            ...
            this.uz = this.$view, this.gt = this.$view.appendChild(e), this.Zn = this.gt.appendChild(i), this.$pdfDoc = null, this.$pageNum = 1, this.$numPages = 0, this.vz = !1, this.wz = null, this.xz = this.Zn.getContext("2d"), this.yz = t.scale || "auto", this.zz = .1, this.Az = t.scaleDelta || 1.1, this.Bz = t.minScale || .25, this.Cz = t.maxScale || 10, this.Dz = 1.25, this.Ez = 40, this.Fz = 10, window.PDFJS ? this.$ready.push(function() {
                ...
                window.PDFJS.workerSrc = "//cdn.webix.com/extras/pdfjs/pdf.worker.min.js", this.load()
        ...
        load: function(t) {
            t = t || this.s.url, t && (this.callEvent("onBeforeLoad"), window.PDFJS.getDocument(t).then(webix.bind(function(t) {
                this.Iz = t, this.$numPages = this.Iz.numPages;
        ...
        Jz: function(t, e) {
            var i = this;
            i.vz = !0, this.Iz.getPage(t).then(function(t) {
                var s = e || i.yz,
                    n = i.Kz(t, s);
        ...
        $init: function(t) {
            ...
            t.cols = [{
                ...
                on: {
                    onChange: function() {
                        e.setMasterScale(this.getValue())
                    }
                }
            }, {
                view: "button",
        ...
        load: function(t) {
            webix.excel.load(t).then(webix.bind(function(t) {
                this.zA = t, this.s.toolbar && webix.$$(this.s.toolbar).setSheets(t.names);
                var e = t.names[0];
                this.showSheet(e.id || e)
            }, this))
        },
        showSheet: function(t) {
            this.clearAll();
            var e = webix.excel.sheetToArray(this.zA.sheets[t]),
            ...
            this.config.columns = i, this.refreshColumns(), this.parse(e, "jsarray")
        }
    }, webix.ui.datatable), webix.excel = {
        load: function(t) {
            if ("string" == typeof t) {
                var e = t.split(".").pop();
                return webix.ajax().response("arraybuffer").get(t).then(function(t) {
                    return webix.excel.parse(t, e)
                })
            }
            ...
            return s.onload = function(t) {
                i.resolve(webix.excel.parse(t.target.result, e))
            }, s.readAsArrayBuffer(t), i
        },
        parse: function(t, e) {
            t = new Uint8Array(t);
            for (var i = [], s = 0; s != t.length; ++s) i[s] = String.fromCharCode(t[s]);
            return e = e.toLowerCase(), "xls" != e && (e = "xlsx"), webix.require("//cdn.webix.com/extras/" + e + ".core.min.js").then(function() {
                var t = "xls" == e ? XLS.read(i.join(""), {
                    type: "binary"
                }) : XLSX.read(i.join(""), {
                    type: "binary"
                });
        ...
        sheetToArray: function(t) {
            var e = [];
            if (t["!ref"]) {
                var i, s, n, r, a = XLS.utils.decode_range(t["!ref"]);
                for (i = a.s.r; i <= a.e.r; i++) {
                    var h = [];
                    for (s = a.s.c; s <= a.e.c; s++) n = XLS.utils.encode_cell({
                        r: i,
                        c: s
                    }), r = t[n], h.push(r ? r.v : "");
                    e.push(h)
        ...
        load: function(t, e) {
            ...
            return webix.excel.load(i[0]).then(function(s) {
                t.data && (t.data.driver = webix.DataDriver.jsarray);
                var n, r = i[1];
                r && r.indexOf("[") && (i = r.split("["), r = i[0], n = i[1].split(/[^0-9]+/g), n[1] = n[1] || 9999999);
                var a = r ? s.sheets[r] : s.sheets[s.names[0]],
                    h = webix.excel.sheetToArray(a);
                n && (h = h.splice(1 * n[0], Math.min(n[1], h.length) - n[0])), webix.ajax.$callback(t, e, "", h, -1)
            })
        }
    }, webix.protoUI({
        name: "treemap",
