  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: '/App/Client/bramus/img/percentImage.png',		// boxImage : image around the progress bar
			barImage	: '/App/Client/bramus/img/percentImage_back.png',	// Image to use in the progressbar. Can be an array of images too.
