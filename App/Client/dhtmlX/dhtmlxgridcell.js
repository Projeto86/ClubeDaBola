...
function dhtmlXFctArrumaValor(avValor, avTipo){
...
function dhtmlXGridCellObject(obj){this.destructor=function(){this.cell.obj=null;this.cell=null;this.grid=null;this.base=null;return null};this.cell=obj;this.getValue=function(){if ((this.cell.firstChild)&&(this.cell.firstChild.tagName == "TEXTAREA"))
 ...
 return "0"};this.edit=function(){};this.isDisabled=function(){return true}};eXcell_price.prototype=new eXcell_ed;eXcell_price.prototype.setValue=function(val){if (isNaN(parseFloat(val))){val=this.val||0};var color = "green";if (val < 0)color="red";this.setCValue("<span>R$ </span><span style='padding-right:2px;color:"+color+";'>"+dhtmlXFctArrumaValor(val,'R')+"</span>", val)};function eXcell_dyn(cell){this.base=eXcell_ed;this.base(cell)
